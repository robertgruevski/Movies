...
public class MoviesController : ControllerBase
{
    ...
    public async Task<ActionResult<MovieDetailsDTO>> Get(int id)
    {
        ...
        if (movieHasBeenRated)
        {
            ...
            if (HttpContext.User.Identity!.IsAuthenticated)
            {
                ...
                var ratingDb = await context.MovieRatings.FirstOrDefaultAsync(mr => mr.MovieId == id && mr.UserId == userId);
    ...
    public async Task<ActionResult> Put(int id, [FromForm] MovieCreationDTO movieCreationDTO)
    {
        ...
        if (movieCreationDTO.Poster is not null)
        {
            movie.Poster = await fileStorage.Edit(movie.Poster, container, movieCreationDTO.Poster);
        }
