...
public class AutoMapperProfiles : Profile
{
    ...
    private void ConfigureMovies()
    {
        CreateMap<MovieCreationDTO, Movie>()
            ...
            .ForMember(ent => ent.MoviesActors, dto =>
                dto.MapFrom(p => p.Actors!.Select(actor => new MovieActor { ActorId = actor.Id, Character = actor.Character })));
        ...
        CreateMap<Movie, MovieDetailsDTO>()
            ...
            .ForMember(dto => dto.Actors, ent => ent.MapFrom(p => p.MoviesActors));
    ...
    private void ConfigureTheaters(GeometryFactory geometryFactory)
    {
        ...
        CreateMap<TheaterCreationDTO, Theater>()
            .ForMember(entity => entity.Location, dto => dto.MapFrom(p => geometryFactory.CreatePoint(new Coordinate(p.Longitude, p.Latitude))));
    }
